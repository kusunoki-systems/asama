...
Public Class M_DrugEX
    ...
    End Sub
    'Public Sub New(db As AsamaEntities, FacilityId As String, model As M_Drug)
    ...
    '        Throw New Exception("Public Sub New(db As AsamaEntities, model As M_Drug)" & ex.Message & ex.StackTrace)
    '    End Try

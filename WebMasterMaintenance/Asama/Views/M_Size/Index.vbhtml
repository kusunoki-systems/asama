...
@For Each item In Model
    @<tr>
        ...
        <td>
            @Html.ActionLink("Edit", "Edit", New With {.id = item.SizeCd }) |
            @Html.ActionLink("Details", "Details", New With {.id = item.SizeCd }) |
            @Html.ActionLink("Delete", "Delete", New With {.id = item.SizeCd })
        </td>
    </tr>
Next

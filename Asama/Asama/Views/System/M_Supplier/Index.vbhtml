...
@For Each item In Model
    @<tr>
         <td>
             @Html.ActionLink(item.SupplierCd, "Edit", New With {.id = item.SupplierCd}, New With {.class = ""})
         </td>
         <td>
        ...
        <td>
            @Html.ActionLink("削除", "Delete", New With {.id = item.SupplierCd}, New With {.class = "btn btn-danger btn-sm"})
        </td>
    </tr>
Next
